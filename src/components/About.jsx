  ...
  return (
    <section className="flex flex-col items-center justify-center bg-[#FFAA02] text-black">
        <div className="flex flex-col items-center justify-center max-w-[530px]">
            ...
            <p className="text-[#100E09] md:text-[19px] px-8 md:p-0 text-center">Bloqva is a revolutionary video platform designed to empower content creators in the music and film industry by providing a decentralized ecosystem where they can monetize their work efficiently. The platform operates on block chain technology,utilizing native cryptocurrrency token called bloquy.</p>
        </div>
